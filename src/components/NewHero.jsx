...
const NewHero = () => {
  ...
  return (
    <div className='heroBg relative'>
      ...
      <div className="flex-col flex lg:pl-20 pt-10 pb-10 items-center md:items-start md:pl-20">
        ...
        <div className="flex flex-col lg:flex-row mt-8 gap-4 items-center sm:px-4 md:p-0 md:pr-8">
          <div className="bulletin bg-white h-52 sm:w-96 w-[95%]">
            ...
            <marquee behavior="scroll" direction="up" height="140" scrollamount="3" className="p-8">
              ...
              <p className='pb-4 border-b-2 border-black mt-4'>{`>  `}Vivek Santosh Rahangdale got selected in AIIMS Nagpur, which is the an All India Top Rank College in 1st attempt.</p>
              <p className='pb-4 border-b-2 border-black mt-4'>{`>  `}Avani Ridhorkar got into NIT Raipur. Other students also bagged top admits from colleges like VNIT Nagpur, COEP pune, VIT Pune etc.</p>
              <p className='pb-4 border-b-2 border-black mt-4'>{`>  `}Rohit Rahangdale, with his arduous efforts was admitted to N.K.P. Salve Medical College, Nagpur for M.B.B.S.</p>
              <p className='pb-4 border-b-2 border-black mt-4'>{`>  `}Students did well in not only engineering exams but also medical exams as two of them got into B.A.M.S.</p>
              <p className='pb-4 border-b-2 border-black mt-4'>{`>  `}Disha A. Damahe and Neddhi R Kamthe got into VSMP'S Dental College Nagpur B.D.S and S.D.K.S Dental College Nagpur B.D.S respectively. </p>
            </marquee>
          </div>
      ...
      <div className="pngMobile">
        <img src={data.details[2].img} alt="" />
      </div>
      {openPopUp ?
        <div className=''>
