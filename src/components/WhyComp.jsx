  ...
  return (
    <div className='flex flex-col justify-center items-center p-4 mt-4'>
      ...
      <div className='flex flex-col flex-wrap md:flex-row justify-around mx-0 relative'>
        ...
        <div ref={ref} className={inView ? "bg-white rounded-md shadow-lg p-8 w-80 flex flex-col gap-2 m-4  aniBox1" : ""}>
        ...
        <div ref={ref} className={inView ? "bg-white rounded-md shadow-lg p-8 w-80 flex flex-col gap-2 m-4 delay-800 aniBox2" : ""}>
        ...
        <div ref={ref} className={inView ? "bg-white rounded-md shadow-lg p-8 w-80 flex flex-col gap-2 m-4 delay-400 aniBox3" : ""}>
        ...
        <div ref={ref} className={inView ? "bg-white rounded-md shadow-lg p-8 w-80 flex flex-col gap-2 m-4 delay-600 aniBox4" : ""}>
