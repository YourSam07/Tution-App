...
const ContactRIdeSide = () => {
  ...
  return (
    <div className="flex contactBg flex-col md:flex-row p-4 gap-12 lg:p-12 xl:py-16 xl:px-60 justify-between ">
      ...
      <div  className={inView ? 'p-8 flex flex-col md:mt-4 justify-centeritems-center rounded-lg shawdow-xl bg-white shadow-lg aniBox7' : 'opacity-0'}>
        ...
        <button className='px-6 py-2 mt-4 bg-green-400 shadow-md rounded-sm hover:bg-green-200'>
          <a href="https://wa.me/+919075957279" target="_blank">Message on Whatsapp</a>
        </button>
