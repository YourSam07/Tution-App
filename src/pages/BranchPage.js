  ...
  return (
    <div className='mt-20 px-8 py-8 md:px-16 whypadding'>
      ...
      <div className="flex flex-col mt-16">
        <div id="square" className="flex flex-col md:flex-row items-center justify-between w-full md:h-[30vh]">
          <div ref={ref} className={inView ? 'flex flex-col aniBox1 w-1/2' :'opacity-0'}>
        ...
        <div id="omkar" ref={ref} className="flex flex-col md:flex-row-reverse my-24 items-center justify-between gap-12 w-full md:h-[30vh]">
          ...
          <div className={inView ? 'map w-1/2 aniBox1' : 'opacity-0'}>
            <iframe className='rounded-md shadow-lg overflow-hidden' title="map" height="300" width={mobileView ? "400" : "600"} frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=6-192,%20Srinagar%20-%20Kanyakumari%20Hwy,%20Narendra%20Nagar,%20Chatrapati%20Nagar,%20Nagpur,%20Maharashtra%20440015+(Head%20Office%20-%20Chatrappati%20Sqaure)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/distance-area-calculator.html">measure area map</a>
            </iframe>
          </div>
