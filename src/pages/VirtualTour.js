...
const VirtualTour = () => {
  ...
  const [currImg, setCurrImg] = useState(data.vrImages.buildingView[0])
  const openSubMenu = (i) => {
  ...
  return (
    <div className="min-h-[89.5vh] relative">
      <div className="absolute top-0 left-0 h-full w-full">
        ...
        />
        <div className="menu fixed right-10 top-[15vh] bg-white shadow-3xl rounded-lg overflow-hidden">
          ...
          {viewOpen ? <ul className="flex flex-col">
            <li className="p-4 hover:bg-red-500 hover:text-white cursor-pointer" onClick={() => setCurrImg(data.vrImages.buildingView[0])}>
              Main Building
            </li>
            <li
